                ...
                <div className="">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                        <span className="block">
                            Sách mới - Mang trí thức đến mọi nơi
                        </span>
                    </h2>
                    <p className="mt-4 text-lg text-gray-800">
                        ...
                        là nhà sách trực tuyến đáng tin cậy, cung cấp hàng ngàn
                        sách đa dạng về mọi lĩnh vực. Giao diện thân thiện, dễ
                        sử dụng. Tìm kiếm và đặt hàng thuận tiện. Dịch vụ chuyên
                        nghiệp, đóng gói cẩn thận, vận chuyển nhanh chóng. Chất
                        lượng sách đa ngôn ngữ, xuất bản phẩm đa dạng. Tham gia{" "}
                        <a href="/" className="text-blue-600">
                            Sachmoi.vn
                        </a>{" "}
                        ngay để khám phá thế giới sách phong phú và thỏa mãn đam
                        mê đọc sách.
                    </p>
                    <div className="mt-8">
